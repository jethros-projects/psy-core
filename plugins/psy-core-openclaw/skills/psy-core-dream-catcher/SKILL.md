...
description: Use when reviewing, scheduling, or reporting OpenClaw Dreaming changes captured by psy-core.
...
Use this skill to turn psy-core dream receipts into a human nightly review.
...
Run the report against the same audit DB the OpenClaw plugin writes:
...
2. Read changed dream artifacts if the report shows any.
